...
const bundlePaths = [
  ...
  "install-reference/lanes/registry.json",
  "install-reference/lane-registry.mjs",
  "install-reference/profile-smoke-contract.mjs",
  "install-reference/conformance-contract.mjs",
  "install-reference/render-contract.mjs",
  "install-reference/stop-points.mjs",
  "install-reference/stages",
]
...
function buildBundleReadme({
  ...
  return [
    ...
    "- `install.md`",
    "- `.template/`",
    "- runtime install-reference contracts and stage YAML files",
    "- `README.md` and `CHANGELOG.md` for consumer context",
    "",
    ...localPackageSection,
    "## Not Included",
    "",
    "- install-reference tests and fixtures",
