...
.opencode/skills/gstack/bin/gstack-timeline-log '{"skill":"canary","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
```bash
eval "$(.opencode/skills/gstack/bin/gstack-slug 2>/dev/null || echo "SLUG=unknown")"
