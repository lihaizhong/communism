...
.opencode/skills/gstack/bin/gstack-timeline-log '{"skill":"design-html","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
[ -z "$_PRETEXT_VENDOR" ] && [ -f .opencode/skills/gstack/design-html/vendor/pretext.js ] && _PRETEXT_VENDOR=.opencode/skills/gstack/design-html/vendor/pretext.js
